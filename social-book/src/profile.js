      ...
      <div className="pofile-container">
        ...
        <div className="profile-details">
          ...
          <div className="pd-right">
            <button type="button">
              <img src="images/add-friends.png" /> Friends
            </button>
            <button type="button">
          ...
          <div className="info-col">
            <div className="profile-intro">
              ...
              <ul>
                ...
                <li>
                  <img src="images/profile-home.png" /> Lives in Bangalore,
                  India
                </li>
                <li>
                  <img src="images/profile-location.png" /> From Bangalore,
                  India
                </li>
              </ul>
            </div>
            ...
            <div className="profile-intro">
              ...
              <div className="friends-box">
                <div>
                  <img src="images/member-1.png" /> <p>Joseph N</p>
                </div>
                <div>
                  <img src="images/member-2.png" /> <p>Nathan N</p>
                </div>
                <div>
                  <img src="images/member-3.png" /> <p>George D</p>
                </div>
                <div>
                  <img src="images/member-4.png" /> <p>Francis L</p>
                </div>
                <div>
                  <img src="images/member-5.png" /> <p>Anthony E</p>
                </div>
                <div>
                  <img src="images/member-6.png" /> <p>Michael A</p>
                </div>
                <div>
                  <img src="images/member-7.png" /> <p>Edward M</p>
                </div>
                <div>
                  <img src="images/member-8.png" /> <p>Brandon C</p>
                </div>
                <div>
                  <img src="images/member-9.png" /> <p>James Doe</p>
                </div>
              </div>
            </div>
          </div>
          <div className="post-col">
            ...
            <div className="post-container">
              ...
              <p className="post-text">
                Subscribe <span>@Easy Tutorials</span> Youtube Channel to watch
            ...
            <div className="post-container">
              ...
              <p className="post-text">
                ...
                <span>@Easy Tutorials</span>facebook page on your post. Ask your
                dobuts in the comments. <a href="#">#EasyTutorials</a>{" "}
